<?php
    ...
    class alex_comp extends CModule
    {
        var $MODULE_ID  = 'alex.comp';
        ...
        {
            $classHandler = 'CIBlockPropertyCpropAlex';
            $classHandlerUF = 'CCustomTypeCompAlex';
            $eventManager = EventManager::getInstance();

            $arEvents = $this->getEvents();
            foreach($arEvents as $arEvent){
                $class = $arEvent['EVENT'] == 'OnIBlockPropertyBuildList' ? $classHandler : $classHandlerUF;
